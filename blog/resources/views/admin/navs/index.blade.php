...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo;  自定义导航接管理
    </div>
    <!--面包屑导航 结束-->
                    ...
                    @foreach( $data as $v )
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:voie()" onclick="delNav( {{$v->nav_id}} )">删除</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
    ...
    <script>
        ...
        function changeOrder(obj,nav_id)
        {
            ...
            $.post("{{url('admin/navs/changeorder')}}",{'_token':'{{csrf_token()}}','nav_id':nav_id,'nav_order':nav_order},function (data) {
                ...
                //data.status=0?layer.msg(data.msg, {icon: 5}):layer.msg(data.msg, {icon: 6});
            });
        }
